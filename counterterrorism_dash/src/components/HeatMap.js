...
function HeatMap(props) {
    ...
    // console.log(props.data.hMap_sympathy[props.timestep])
    // console.log(props.data.hMap_act_x[props.timestep])
    // console.log(props.data.hMap_act_y[props.timestep])

    // console.log(props.data.hMap_num_combats[props.timestep])
    // console.log()
    ...
    const data = [
        ...
        {
            x: props.data.hMap_act_y[props.timestep],
            y: props.data.hMap_act_x[props.timestep],
            mode: "markers",
            marker: {
                color: "#ffffff",
